...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                var contentWidth = 0;
                var loader,msgBox,elmActionBar,elmStepContainer,btNext,btPrevious,btSubmit,btFinish;
                ...
                function init(){
                  ...
                  btSubmit = $('<a>'+options.labelSubmit+'</a>').attr("href","#").addClass("buttonFinish");
                  ...
                  $(btFinish).click(function() {
                      if(!$(this).hasClass('buttonDisabled')){
                         if($.isFunction(options.onSubmit)) {
                            if(!options.onSubmit.call(this,$(steps))){
                              return false;
                            }
                         }else{
                           ldDialog.alert("暂存成功！");
                ...
                function adjustButton(){
                  ...
                  if(!steps.hasClass('disabled') || options.enableFinishButton){
                   /* $(btFinish).removeClass("buttonDisabled");*/
                    $(btSubmit).removeClass("buttonDisabled");
                  }else{
                   /* $(btFinish).addClass("buttonDisabled");*/
                     $(btSubmit).addClass("buttonDisabled");
                  }                  
                }
    ...
    $.fn.smartWizard.defaults = {
          ...
          onSubmit: null  // triggers when Finish button is clicked
    };    
