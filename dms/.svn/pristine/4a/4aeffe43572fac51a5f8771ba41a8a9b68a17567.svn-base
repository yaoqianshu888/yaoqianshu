...
<script type="text/javascript">
	function checkSubmit() {
		...
		if (upload.value == "") {
			ldDialog.alert("请上传文件!");
			return false;
		}
		submitForm();
	}
	function submitForm(){
		var url = "${basePath}coreAjax/checkstandVersionInsert!insert.action";
...
<body>
	<form id="submitForm" method="post" name="form1"
			...
			<table width="100%" border="0" align="center" cellspacing="10" cellpadding="0">
				...
				<tr>
					...
					<td><ld:select id="checkstandVersion.isForceUpdate" name="checkstandVersion.isForceUpdate"
							groupName="yesOrNoInt" className="ldSelect select144" value="${checkstandVersion.posType.id}"
							exceptValue="${options.common.EMTRY}" /></td>
				</tr>
				<tr>
					<td width="100" align="right"><span class="font12">*</span> 版本编码</td>
					<td class="dmg-listli-item5"><input type="text" id="checkstandVersion.versionNum"
							name="checkstandVersion.versionNum" maxlength="8" class="ldText" value="${checkstandVersion.versionNum}" /></td>
				...
				<tr>
					<td width="100" align="right"><span class="font12">*</span> 文件路径</td>
		...
		<div class="dialogBottom">
			<div class="btns">
				<ld:check mark="checkstandVersionInsertCommit">
