...
<script type="text/javascript">
	...
	function submitForm(){
		var url = "${basePath}coreAjax/areaInsert!insert.action";
		$.ajax({
			type : "POST",
			url : url,
			dataType : "text",
	...
	$(function(){
		var url = "${basePath}coreAjax/areaSearch!getParentAreaDetail.action?area.superAreaId=${area.superAreaId}";
		$.ajax({
			type : "POST",
			url : url,
			dataType : "text",
...
<body>
	<form id="submitForm" method="post">
		<input type="hidden" name="area.superAreaId"
			value="${area.superAreaId }">
		<div class="dialogTop">
			<table width="400" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="210" id="parentAreaInfo"></td>
				</tr>
				<tr>
					<td width="80" align="right">
		...
		<div class="dialogBottom">
			<div class="btns">
				<ld:check mark="areaInsertCommit">
